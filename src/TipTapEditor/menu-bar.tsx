  ...
  const ACTIONS = [
    ...
    },
    {
      ...
      },
      {
        ...
        icon: Highlighter, // Substitua com um ícone relevante
      ...
      },
      {
        label: "Borda Verde",
        icon: Highlighter,
        action: () => editor.chain().focus().updateAttributes('table', { borderColor: 'green' }).run(),
        active: editor.isActive('table', { borderColor: 'green' }),
      },
  ];
